...
interface SignInPageProps {
  ...
  showAdminLoginToggle?: boolean;
  onSignIn?: (event: React.FormEvent<HTMLFormElement>) => void;
  onGoogleSignIn?: (loginAsAdmin: boolean) => void;
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              {showAdminLoginToggle && (
                <div className="animate-element animate-delay-600 flex items-center gap-3 rounded-xl border border-border bg-foreground/5 px-3 py-2">
                  <input
                    type="checkbox"
                    name="loginAsAdmin"
                    id="loginAsAdmin"
                    ...
                    onChange={(event) => setLoginAsAdmin(event.target.checked)}
                  />
                  <label htmlFor="loginAsAdmin" className="text-sm text-foreground/90 cursor-pointer">
                    Sign in as admin
                  </label>
                </div>
              )}
